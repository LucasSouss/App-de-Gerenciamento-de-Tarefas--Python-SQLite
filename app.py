...
class ToDo:
    def __init__(self, page: ft.Page):
        ...
        self.page.window.title = 'Your Tasks'
        self.task = ''
        self.view = 'all'
    ...
    def checked (self, e):
        ...
        if self.view == 'all':
            ...
            self.results = self.db_execute('SELECT * from tasks WHERE status = ?', params=[set.view])

            self.update_task_list()


    def tks_container(self):
        return ft.Container(
    ...
    def main_page(self):
        input_task = ft.TextField(
            hint_text = 'Digite aqui a sua tarefa', expand=True, on_change=self.set_value)
        ...
        tabs = ft.Tabs (
            ...
            tabs=[
                ...
                ft.Tab(text='Finalidados')
            ]
        )

        tks = self.tks_container()
